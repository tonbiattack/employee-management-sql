USE employee;
-- ========================================
-- SQLファイル: spring_boot_resources/data.sql
...
insert into employee.employee(gender_id,employee_status_id,employee_code,family_name,last_name,family_name_furigana,last_name_furigana,date_of_birth,grade,`comment`) values 
    (1,1,'56001','田嶋','研人','タジマ','ケント','1971-11-25',1,'React,Vue.jsなどフロントエンドに詳しい。')
  , (2,1,'11000','中田','あやか','ナカタ','アヤカ','1994-04-16',8,'Railsの知識が素晴らしい。')
  , (3,2,'33000','橘','まゆみ','タチバナ','マユミ','2001-01-15',2,'Railsの知識が素晴らしい。')
  , (1,1,'56002','川嶋','美由紀','カワシマ','ミユキ','1996-11-14',1,'Railsの知識が素晴らしい。')
  , (3,3,'57003','河合','陽子','カワイ','ヨウコ','1994-12-25',1,'React,Vue.jsなどフロントエンドに詳しい。')
  , (3,1,'44001','桑原','えり奈','クワバラ','エリナ','1978-12-07',6,'React,Vue.jsなどフロントエンドに詳しい。');
